...
FAN_API int32   fan_f32_equal(float32 x, float32 y);
...
// NOTE(liam): inverse sqrt
FAN_API float32 fan_f32_rsqrt(float32);


// NOTE(liam): Vector2 operations.
